...
Quelle
http://handball-sr-mittelfranken.de/tabellen/tabellen.js
*/
jQuery(document).ready(function($){
	...
	$("div.srsPlan").each(function() {
		...
		$.each([
			...
			"srsTabellenFormat", "srsNurHalle", "srsOhneHalle"
			], function(i, val) {
			var m = val.match(/^srs(.*)/);
			if (m && o.attr(val)) {p[m[1].toLowerCase()] = o.attr(val); }
			val = "data-" + val;
	...
	var plan_format = [
		...
		"fields": "Spieldatum/^..(..).(..).(..).*/$3.$2.$1;Spieldatum/.*T(..:..).*/$1;Halle_Kuerzel;HeimTeam_Name_kurz;GastTeam_Name_kurz;Heim+%:+Gast",
		"classCol": "l;c;l;l;l;c",
		},
		{ // alles fuer planverein
		"header": "Datum;Zeit;Liga;Halle;Heim;Gast;Ergebnis",
		"fields": "Spieldatum/^..(..).(..).(..).*/$3.$2.$1;Spieldatum/.*T(..:..).*/$1;Liga_Name_kurz;Halle_Kuerzel;HeimTeam_Name_kurz;GastTeam_Name_kurz;Heim+%:+Gast",
		"classCol": "l;c;l;l;l;l;c",
		},
		{ // ohne halle fuer plan
		"header": "Datum;Zeit;Heim;Gast;Ergebnis",
		"fields": "Spieldatum/^..(..).(..).(..).*/$3.$2.$1;Spieldatum/.*T(..:..).*/$1;HeimTeam_Name_kurz;GastTeam_Name_kurz;Heim+%:+Gast",
		"classCol": "l;c;l;l;c",
		},
		{ // ohne halle fuer planverein
		"header": "Datum;Zeit;Liga;Heim;Gast;Ergebnis",
		"fields": "Spieldatum/^..(..).(..).(..).*/$3.$2.$1;Spieldatum/.*T(..:..).*/$1;Liga_Name_kurz;HeimTeam_Name_kurz;GastTeam_Name_kurz;Heim+%:+Gast",
		"classCol": "l;c;l;l;l;c",
		}
		];
