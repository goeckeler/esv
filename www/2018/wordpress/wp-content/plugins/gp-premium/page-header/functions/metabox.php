					...
					<div style="margin-top:12px;">
						...
						<div class="page-header-column">
							...
							<p class="fullscreen">
								...
								<label for="_meta-generate-page-header-full-screen"><?php _e( 'Fullscreen', 'gp-premium' );?></label>
							</p>
						...
						<div class="page-header-column">
							<p>
								...
								<select name="_meta-generate-page-header-image-background-type" id="_meta-generate-page-header-image-background-type">
									<option value="" <?php selected( generate_page_header_get_post_meta( get_the_ID(), '_meta-generate-page-header-image-background-type', true ), '' ); ?>><?php _e( 'Contained', 'gp-premium' );?></option>
							...
							<p>
								...
								<select name="_meta-generate-page-header-inner-container" id="_meta-generate-page-header-inner-container">
									<option value="" <?php selected( generate_page_header_get_post_meta( get_the_ID(), '_meta-generate-page-header-inner-container', true ), '' ); ?>><?php _e( 'Contained', 'gp-premium' );?></option>
